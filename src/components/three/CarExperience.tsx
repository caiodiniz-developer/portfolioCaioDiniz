    ...
    const trigger = ScrollTrigger.create({
      ...
      onUpdate(self) {
        ...
        for (let i = 0; i < CHAPTERS.length - 1; i++) {
          if (self.progress < CHAPTERS[i + 1].range[0]) {
            newIdx = i;
            break;
          }
        }
    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <span className="text-[0.625rem] font-semibold uppercase tracking-[0.14em] text-white/20">
            {chapter.label}
          </span>
        </div>
      </div>
          ...
          <div className="hidden sm:flex flex-col items-end gap-2">
            ...
            <div
              ...
              style={{
                height: "64px",
                background:
                  "linear-gradient(to top, rgba(255,255,255,0.2), rgba(255,255,255,0.03))",
              }}
            />
          </div>
        </div>
