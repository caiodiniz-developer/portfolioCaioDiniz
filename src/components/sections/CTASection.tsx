...
export default function CTASection() {
  ...
  return (
    <section
      ...
      style={{ background: '#0d0d0d', borderTop: '1px solid rgba(255,255,255,0.06)', minHeight: '70vh', display: 'flex', alignItems: 'center' }}
    >
      {/* Video background */}
      <video
      ...
      <div
        ...
        style={{ background: 'linear-gradient(to bottom, rgba(13,13,13,0.65), rgba(13,13,13,0.5), rgba(13,13,13,0.65))' }}
      />
      ...
      <div className="container-custom relative z-10 w-full">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8">
          <p className="cta-sub text-sm text-white/30 leading-relaxed" style={{ maxWidth: 360 }}>
            {t.cta.sub}
          </p>
