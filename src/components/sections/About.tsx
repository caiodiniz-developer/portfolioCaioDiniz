...
const stats = [
  { value: "100%", end: 100, suffix: "%",  labelPt: "Projetos personalizados",          labelEn: "Custom projects",              numeric: true  },
  { value: "Design",end: 0,  suffix: "",   labelPt: "Experiências digitais premium",     labelEn: "Premium digital experiences",  numeric: false },
  { value: "Mobile",end: 0,  suffix: "",   labelPt: "Responsivo em qualquer dispositivo",labelEn: "Responsive on every device",   numeric: false },
  { value: "SEO",   end: 0,  suffix: "",   labelPt: "Otimizado para mecanismos de busca",labelEn: "Search engine optimized",      numeric: false },
  { value: "Secure",end: 0,  suffix: "",   labelPt: "Arquitetura segura e escalável",    labelEn: "Secure & scalable architecture",numeric: false},
  { value: "24h",   end: 24, suffix: "h",  labelPt: "Resposta rápida",                  labelEn: "Fast response time",           numeric: true  },
];
...
export default function About() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.to(".ab-stat",       { y: 0, opacity: 1, duration: 0.65, stagger: 0.08 },   0.38);
      tl.to(".ab-img",        { scale: 1, opacity: 1, duration: 1.1, ease: "power2.out" }, 0.1);
      ...
      stats.forEach((s, i) => {
        ...
        gsap.to(obj, {
          ...
          onUpdate() { el.textContent = Math.floor(obj.val) + s.suffix; },
        });
      });
    }, ref);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ padding: "clamp(5rem, 10vw, 8rem) clamp(1.5rem, 5vw, 4.5rem)" }}
      >
      ...
      <div className="about-img-col relative overflow-hidden" style={{ minHeight: "100vh" }}>
