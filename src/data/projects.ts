...
export const projects: Project[] = [
  {
    ...
    stack: ['React', 'Node.js', 'PostgreSQL', 'Stripe', 'TypeScript', 'Prisma', 'JWT'],
    image: '/assets/projeto-FinixApp.png',
    gallery: [
      '/assets/projeto-FinixApp.png',
      '/assets/projetoeasyton.png',
      '/assets/projeto-Refoud.png',
      '/assets/projeto-prime.png',
    ],
    liveUrl: '#',
    githubUrl: '#',
  ...
  },
  {
    ...
    stack: ['Node.js', 'Prisma', 'JWT', 'PostgreSQL', 'TypeScript', 'Zod', 'Express'],
  ...
  },
  {
    ...
    stack: ['React', 'TypeScript', 'GSAP', 'Vercel', 'Tailwind CSS'],
    image: '/assets/projeto-santaluzia.png',
    gallery: [
      '/assets/projeto-santaluzia.png',
      '/assets/projeto-Matrix.png',
      '/assets/projeto-prime.png',
    ],
    liveUrl: '#',
    githubUrl: '#',
  ...
  },
  {
    ...
    stack: ['React', 'TypeScript', 'GSAP', 'Tailwind CSS', 'Framer Motion'],
    image: '/assets/projeto-Matrix.png',
    gallery: [
      '/assets/projeto-Matrix.png',
      '/assets/projeto-santaluzia.png',
      '/assets/projeto-OngMPBIA.png',
    ],
    liveUrl: '#',
    githubUrl: '#',
    role: 'Front-end Developer & UI Designer',
  ...
  },
  {
    ...
    stack: ['JavaScript', 'HTML', 'CSS', 'Animações CSS'],
